...
var f = c(p(function(e, t) {
  !function(e2) {
    ...
    var V, M;
    e2.PipsMode = void 0, (M = e2.PipsMode || (e2.PipsMode = {})).Range = "range", M.Steps = "steps", M.Positions = "positions", M.Count = "count", M.Values = "values", e2.PipsType = void 0, (V = e2.PipsType || (e2.PipsType = {}))[V.None = -1] = "None", V[V.NoValue = 0] = "NoValue", V[V.LargeValue = 1] = "LargeValue", V[V.SmallValue = 2] = "SmallValue";
    var L = function() {
      ...
      return e3.prototype.getDistance = function(e4) {
        ...
        return e4 = A(this.xPct, this.xSteps, this.snap, e4);
    ...
    function ae(t3, r2, s2) {
      var u3, f3, x2, w2, E2, P2 = b(), N2 = S() && y(), C2 = t3, k2 = r2.spectrum, A2 = [], V2 = [], M2 = [], L2 = 0, U2 = {}, O2 = t3.ownerDocument, j2 = r2.documentElement || O2.documentElement, F2 = O2.body, T2 = "rtl" === O2.dir || 1 === r2.ort ? 0 : 100;
      function z2(e3, t4) {
      ...
      function W2() {
        ge("update" + D.aria), me("update" + D.aria, function(e3, t4, i2, n2, o2) {
          M2.forEach(function(e4) {
            var t5 = f3[e4], n3 = ye(V2, e4, 0, true, true, true), a2 = ye(V2, e4, 100, true, true, true), s3 = o2[e4], l2 = String(r2.ariaFormat.to(i2[e4]));
      ...
      function ae2(e3) {
        ...
        return f3.forEach(function(i2, n2) {
          if (!X2(n2)) {
            var o2 = V2[n2], a2 = Math.abs(o2 - e3);
      ...
      function ue(e3, t4) {
        t4.handle && (m2(t4.handle, r2.cssClasses.active), L2 -= 1), t4.listeners.forEach(function(e4) {
          ...
          Ne(e4, V2[e4], true, true, false, false);
      ...
      function ce(e3, t4) {
        if (!t4.handleNumbers.some(X2)) {
          ...
          var n2 = [], a2 = re2(P2.move, j2, le2, { target: e3.target, handle: i2, connect: t4.connect, listeners: n2, startCalcPoint: e3.calcPoint, baseSize: te2(), pageOffset: e3.pageOffset, handleNumbers: t4.handleNumbers, buttonsProperty: e3.buttons, locations: V2.slice() }), s3 = re2(P2.end, j2, ue, { target: e3.target, handle: i2, listeners: n2, doNotReject: true, handleNumbers: t4.handleNumbers }), l2 = re2("mouseout", j2, se2, { target: e3.target, handle: i2, listeners: n2, doNotReject: true, handleNumbers: t4.handleNumbers });
      ...
      function fe(e3, t4) {
        ...
        if (e3.preventDefault(), d3 || p3) {
          ...
          if (null === v2)
            return false;
          false === v2 && (v2 = k2.getDefaultStep(V2[t4], p3, r2.keyboardDefaultStep)), v2 *= c3 || u4 ? r2.keyboardPageMultiplier : r2.keyboardMultiplier, v2 = Math.max(v2, 1e-7), v2 *= p3 ? -1 : 1, s3 = A2[t4] + v2;
        } else
      ...
      function be(e3, t4, i2) {
        Object.keys(U2).forEach(function(n2) {
          ...
          e3 === o2 && U2[n2].forEach(function(e4) {
            e4.call(Te, A2.map(r2.format.to), t4, A2.slice(), i2 || false, V2.slice(), Te);
          });
        });
      }
      ...
      function Ee(e3, t4) {
        V2[e3] = t4, A2[e3] = k2.fromStepping(t4);
        var i2 = "translate(" + Se(we(t4, 0) - T2 + "%", "0") + ")";
        f3[e3].style[r2.transformRule] = i2, Ce(e3), Ce(e3 + 1);
      }
      function Pe() {
        M2.forEach(function(e3) {
          var t4 = V2[e3] > 50 ? -1 : 1, r3 = 3 + (f3.length + t4 * e3);
          f3[e3].style.zIndex = String(r3);
        });
      }
      function Ne(e3, t4, r3, i2, n2, o2) {
        return n2 || (t4 = ye(V2, e3, t4, r3, i2, false, o2)), false !== t4 && (Ee(e3, t4), true);
      }
      function Ce(e3) {
        if (x2[e3]) {
          var t4 = 0, i2 = 100;
          0 !== e3 && (t4 = V2[e3 - 1]), e3 !== x2.length - 1 && (i2 = V2[e3]);
          var n2 = i2 - t4, o2 = "translate(" + Se(we(t4, n2) + "%", "0") + ")", a2 = "scale(" + Se(n2 / 100, "1") + ")";
          x2[e3].style[r2.transformRule] = o2 + " " + a2;
        }
      }
      function ke(e3, t4) {
        return null === e3 || false === e3 || void 0 === e3 ? V2[t4] : ("number" == typeof e3 && (e3 = String(e3)), false !== (e3 = r2.format.from(e3)) && (e3 = k2.toStepping(e3)), false === e3 || isNaN(e3) ? V2[t4] : e3);
      }
      function Ae(e3, t4, i2) {
        var n2 = d2(e3), o2 = void 0 === V2[0];
        ...
        if (o2 && k2.hasNoSize() && (i2 = true, V2[0] = 0, M2.length > 1)) {
      ...
      function Le(e3) {
        if (void 0 === e3 && (e3 = false), e3)
          return 1 === A2.length ? A2[0] : A2.slice(0);
        var t4 = A2.map(r2.format.to);
      ...
      function Oe(e3) {
        var t4 = V2[e3], i2 = k2.getNearbySteps(t4), n2 = A2[e3], o2 = i2.thisStep.step, a2 = null;
        if (r2.snap)
      ...
      function je(e3, t4) {
        ...
        }), k2 = a2.spectrum, r2.margin = a2.margin, r2.limit = a2.limit, r2.padding = a2.padding, r2.pips ? ee2(r2.pips) : Z2(), r2.tooltips ? I2() : Y2(), V2 = [], Ae(n(e3.start) ? e3.start : i2, t4);
      }
      function Fe() {
        u3 = B2(C2), R2(r2.connect, u3), he(r2.events), Ae(r2.start), r2.pips && ee2(r2.pips), r2.tooltips && I2(), W2();
      }
      Fe();
      var Te = { destroy: Ue, steps: De, on: me, off: ge, get: Le, set: Ae, setHandle: Me, reset: Ve, __moveHandles: function(e3, t4, r3) {
        xe(e3, t4, V2, r3);
...
var m = { name: "Slider", emits: ["input", "update:modelValue", "update", "change"], props: { ...{ value: { validator: function(e) {
  ...
  const l = function(r, i, n) {
    const { value: o, modelValue: a2 } = toRefs(r), s2 = a2 && void 0 !== a2.value ? a2 : o, l2 = ref(s2.value);
    if (u(s2.value))
      throw new Error("Slider v-model must be a Number or Array");
    if (Array.isArray(s2.value) && 0 == s2.value.length)
      throw new Error("Slider v-model must not be an empty array");
    return { value: s2, initialValue: l2 };
  }(a), c2 = function(t, i, n) {
    ...
    const { orientation: c3, direction: p3, tooltips: d2, step: m3, min: v, max: g, merge: b, id: y, disabled: S, options: x, classes: w, format: E, lazy: P, ariaLabelledby: N, aria: C } = toRefs(a2), k = l2.value, A = l2.initialValue, V = l2.tooltipsFormat, M = l2.tooltipsMerge, L = l2.tooltipFormat, U = l2.classList, O = ref(null), D = ref(null), j = ref(false), F = computed(() => {
      let e = { cssPrefix: "", cssClasses: U.value, orientation: c3.value, direction: p3.value, tooltips: !!d2.value && V.value, connect: "lower", start: u(k.value) ? v.value : k.value, range: { min: v.value, max: g.value } };
      ...
      D.value = f.create(O.value, Object.assign({}, F.value, x.value)), d2.value && z.value && b.value >= 0 && M(O.value, b.value, " - "), D.value.on("set", (e) => {
        const t = H();
        s2.emit("change", t), P.value && R(t);
      }), D.value.on("update", (e) => {
        if (!j.value)
          return;
        const t = H();
        z.value && h(k.value, t) || !z.value && k.value == t ? s2.emit("update", t) : P.value || R(t);
    ...
    return onMounted(B), onUnmounted(_), watch(k, (e, t) => {
      t && ("object" == typeof t && "object" == typeof e && e && Object.keys(t) > Object.keys(e) || "object" == typeof t && "object" != typeof e || !e) && $();
    }, { immediate: false }), watch(z, $, { immediate: false }), watch(v, $, { immediate: false }), watch(g, $, { immediate: false }), watch(m3, $, { immediate: false }), watch(c3, $, { immediate: false }), watch(p3, $, { immediate: false }), watch(d2, $, { immediate: false }), watch(b, $, { immediate: false }), watch(E, $, { immediate: false, deep: true }), watch(x, $, { immediate: false, deep: true }), watch(w, $, { immediate: false, deep: true }), watch(k, (e) => {
      if (u(e))
...
// dep:@vueform_slider
var vueform_slider_default = m;
export {
  vueform_slider_default as default
};
