...
declare type VKRetargeting = {
    /**
     * Retargeting tag
     */
    id: string;
};
declare type VKRetargetingOption = VKRetargeting | VKRetargeting[];
...
declare function VitePluginRadar({ enableDev, analytics, gtm, pixel, linkedin, tongji, metrica, microsoft, retargeting, }: VitePluginRadarOptions): Plugin;
