...
const emoji_test_copy = require('./emoji/test/copy.cjs');
...
exports.mapEmojiSequences = emoji_cleanup.mapEmojiSequences;
exports.removeEmojiTones = emoji_cleanup.removeEmojiTones;
exports.removeEmojiVariations = emoji_cleanup.removeEmojiVariations;
...
exports.getQualifiedEmojiSequencesMap = emoji_test_parse.getQualifiedEmojiSequencesMap;
...
exports.getEmojisSequencesToCopy = emoji_test_copy.getEmojisSequencesToCopy;
