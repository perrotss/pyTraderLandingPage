...
export { getIconCSS } from './css/icon.mjs';
export { getIconsCSS } from './css/icons.mjs';
...
export { getEmojiSequenceFromString, getUnqualifiedEmojiSequence, mapEmojiSequences, removeEmojiTones, removeEmojiVariations } from './emoji/cleanup.mjs';
...
export { getEmojiSequenceString, getEmojiUnicodeString } from './emoji/format.mjs';
export { getQualifiedEmojiSequencesMap, parseEmojiTestFile } from './emoji/test/parse.mjs';
export { getQualifiedEmojiVariations } from './emoji/test/variations.mjs';
export { getEmojisSequencesToCopy } from './emoji/test/copy.mjs';
